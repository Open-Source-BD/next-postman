'use client';
import { computeEdit } from '../lib/editorKeys';
...
/** Textarea with code-editor key handling: auto-pairing, overtype, smart Enter/Tab. */
export function CodeTextarea({ value, onChange, ...rest }: Props) {
